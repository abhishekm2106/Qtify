import { FlexBox, primaryBlack, primaryColor, primaryWhite } from "./Styles";
import styled from 'styled-components'
import logo from '../assets/logo.png'

const NavbarElement = styled(FlexBox)`
...
const SearchBar = styled(FlexBox)`
    ...
    overflow: hidden;
    width: 40%;
    border : ${primaryBlack} 1px solid;
    input{
        padding: .5rem 1rem;
        border: none;
        outline: none;
        flex: 1;
        border-right: ${primaryBlack} 1px solid;
